<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="dprofilis.aspx.cs" Inherits="Webas.dprofilis" %>
...
<div class="col-md-4">
    ...
    <div class="form-group">
      <div class="form-group">
    <asp:TextBox CssClass="form-control" ID="TextBox7" runat="server" placeholder="Mokomasis dalykas" ReadOnly="True"> </asp:TextBox>
        </div>
          </div>
      </div>
