<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Pridetidestytoja.aspx.cs" Inherits="Webas.Pridetidestytoja" %>
...
<br /> <asp:Button class="btn btn-success" ID="button1" runat="server" Text="Sukurti profilį" OnClick="button1_Click" />
  <asp:Button class="btn btn-danger" ID="button2" runat="server" Text="Panaikinti profilį" OnClick="button2_Click" /><br />
   </div>
     ...
     SelectCommand="SELECT * FROM [destytojas]"></asp:SqlDataSource>
                      <div class="col">          
